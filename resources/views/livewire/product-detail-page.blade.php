                    ...
                    <div class="sticky top-0 z-50 overflow-hidden ">
                        ...
                        <div class="flex-wrap hidden md:flex ">
                            @foreach ($product->images as $item)
                                <div class="w-1/2 p-2 sm:w-1/4" x-on:click="mainImage='{{ $item }}'">
                        ...
                        <div class="mb-8 ">
                            ...
                            <p class="inline-block mb-6 text-4xl font-bold text-gray-700 dark:text-gray-400 ">
                                @if ($product->on_sale == 1)
                                    <span>{{ Number::currency($product->new_price * 24680, 'VND') }}</span>
                                    <span class="text-base font-normal text-gray-500 line-through dark:text-gray-400">
                                        {{ Number::currency($product->old_price * 24680, 'VND') }}
                                    </span>
                                @else
                                    <span>{{ Number::currency($product->old_price * 24680, 'VND') }}</span>
                                @endif
                            </p>
